  ...
  Future<void> _writeToFile() async {
    try {
      ...
      if (await file.exists()) {
        // Append new user data to the existing file
        await file.writeAsString(newUser, mode: FileMode.append);
      } else {
        // Create a new file and write user data
        await file.writeAsString(newUser);
      }
